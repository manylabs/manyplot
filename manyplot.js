// a PlotHandler object is simplified wrapper around the Plotter object; we should probably merge it with the Plotter object
function createPlotHandler(canvas, multiFrame) {
	...
	plotHandler.drawPlot = function(xMouse, yMouse, args) {
		if (args === undefined) {
			args = {};
		}
		if (args['useTimestamp'] === undefined) {
			args['useTimestamp'] = true;
		}
		if (args['presentIsZero'] === undefined) {
			args['presentIsZero'] = false;
		}
...
// returns a plotter object for displaying numeric plots on a canvas context
